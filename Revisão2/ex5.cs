...
public class Program {
  ...
  public static void Main(string[] args) {
    ...
    switch(x){
      ...
      case 4: Console.WriteLine("O mês de Abril é do primeiro trimestre do ano"); break;
      ...
      case 7: Console.WriteLine("O mês de Julho é do segundo trimestre do ano"); break;
      case 8: Console.WriteLine("O mês de Agosto é do segundo trimestre do ano"); break;
      case 9: Console.WriteLine("O mês de Setembro é do terceiro trimestre do ano"); break;
      case 10: Console.WriteLine("O mês de Outubro é do terceiro trimestre do ano"); break;
      case 11: Console.WriteLine("O mês de Novembro é do terceiro trimestre do ano"); break;
      case 12: Console.WriteLine("O mês de Dezembro é do terceiro trimestre do ano"); break;
   }
  }
}